...
const ProjectCard = ({ project }) => {
  return (
    <>
      <div className="card max-w-[400px] overflow-hidden w-full bg-base-100 shadow-xl">
        <div>
          <div
        ...
        <div className="card-body bg-[rgb(17,24,39)]">
          ...
          <p className="mb-10">
            {project.description.length >= 100 ? project.description.slice(0, 160) : project.description} ...
          </p>
          <div className="card-actions justify-between">
            ...
            <div className="h-full flex justify-center rounded-full items-center ">
              <Link to={"/project-details/" + project.id} className="text-secondary btn-primary rounded-full px-4 py-1 " >
                More Details
              </Link>
            </div>
          </div>
